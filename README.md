...
---
＃＃＃＃ 安装：
1. 单击[此处](https://github.com/pointfeev/CreamInstaller/releases/latest/download/CreamInstaller.zip)从[GitHub](https://github.com/pointfeev/CreamInstaller)下载最新版本 ）。
